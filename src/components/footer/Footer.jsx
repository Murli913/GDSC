        ...
        <div className="footer-carousel owl-carousel flex justify-between items-center">
          <div className="pl-4">
            <a
              ...
              className="ext-link w-1/6"
            >
              <img alt="india-gov" src={link1} />
            </a>
          </div>
          <div className="pl-4">
            <a
              href="https://www.safetolearncoalition.org/"
              target="_blank"
              title="External site that opens in a new window"
              className="ext-link w-1/6"
            >
              <img alt="mygov" src={link2} />
            </a>
          </div>
          <div className="pl-4">
            <a
              href="https://violenceagainstchildren.un.org/"
              target="_blank"
              title="External site that opens in a new window"
              className="ext-link w-1/6"
            >
              <img alt="data-gov" src={link3} />
            </a>
          </div>
          <div className="pl-4">
            <a
              href="https://www.end-violence.org/"
              target="_blank"
              title="External site that opens in a new window"
              className="ext-link w-1/6"
            >
              <img alt="nic" src={link4} />
            </a>
          </div>
          <div className="pl-4">
            <a
          ...
          <div className="pl-4">
            <a
              ...
              className="ext-link w-1/6"
            >
              <img alt="Group of Twenty (G20)" src={link6} />
            </a>
          </div>
        </div>
      </section>
