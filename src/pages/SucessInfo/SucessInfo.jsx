...
const SucessInfo = () => {
  ...
  const addLikes = async () => {
    try {
      ...
      const likesRef = doc(fireDb, "sucessstory", params.id);
  ...
  const addDislikes = async () => {
    try {
      ...
      const dislikesRef = doc(fireDb, "sucessstory", params.id);
  ...
  const getAllBlogs = async () => {
    setloading(true);
    try {
      const blogPostRef = doc(fireDb, "sucessstory", params.id);
  ...
  const addReply = async (commentId, replyText) => {
    const commentRef = doc(fireDb, "sucessstory", params.id, "comment", commentId);
    try {
